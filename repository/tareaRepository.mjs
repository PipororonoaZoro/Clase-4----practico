...
export default class TareaRepository extends TareasDataSource
{
    ...
    obtenerTodas()
    {
        try
        {
            // Leer el archivo de texto em formato UTF-8   
    ...
    guardar(tareas)
    {
        try
        {
            // Convertir el array de tareas a una cadena JSONcon indentación de 2 espacios
    ...
    // Implementacion del método eliminar()
    eliminar(id)
    {
        try
        {
